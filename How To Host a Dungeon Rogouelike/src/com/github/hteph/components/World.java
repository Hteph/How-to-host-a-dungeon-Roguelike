...
public class World {
	...
	private int height;
	public int height() { return height; }//TODO change to a getter?
	
	private List<Creature> creatures;
	
	private int depth;
	public int depth() { return depth; } //TODO change to a getter?
...
//Methods ---------------------------------------------------------------------
	...
	public Tile tile(int x, int y, int z){ //TODO change to checkTile?
	...
	public Creature creature(int x, int y, int z){ //TODO strange name for a function that checks a place for a creature
